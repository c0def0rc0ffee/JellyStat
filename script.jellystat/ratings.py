...
def _connect():
    ...
    """
    <summary>
    The mirror connection; the rating columns live in library's schema.
    </summary>
...
def _request(url, token, method, body=None):
    """
    <summary>
    One authenticated call to Jellyfin.
    </summary>
    <param name="url">Full URL.</param>
    <param name="token">API key or access token.</param>
    <param name="method">HTTP method.</param>
    <param name="body">A JSON serialisable body, or None.</param>
    <returns>A tuple of the HTTP status and the decoded body, or None for an empty body.</returns>
    <remarks>
...
def _user_data_url(creds, item_id):
    ...
    <param name="item_id">The item.</param>
...
def _push_favourite(creds, item_id, wanted):
    """
    <summary>
    Mark or unmark an item as a favourite on Jellyfin.
    </summary>
    <param name="creds">A credentials dict.</param>
    <param name="item_id">The item.</param>
    <param name="wanted">True to mark, False to clear.</param>
    """
