...
def _daypart(hour):
    """
    <summary>
    The named part of the day an hour falls in, handling the one that wraps midnight.
    </summary>
    <param name="hour">0 to 23.</param>
    <returns>A DAYPARTS name, Night when nothing matches.</returns>
    """
...
def _days(start, count):
    """
    <summary>
    Consecutive dates from a start, as YYYY-MM-DD strings.
    </summary>
    <param name="start">A date.</param>
