...
def valid_id(value):
    """
    <summary>
    Whether a string looks like a Jellyfin item id.
    </summary>
...
def _video_stream(source):
    """
    <summary>
    The first video stream of a media source, or an empty dict.
    </summary>
    <param name="source">A MediaSources entry.</param>
    <returns>The stream dict.</returns>
    """
...
def runtime_minutes(item):
    """
    <summary>
    An item's runtime in whole minutes from its ticks, or None.
    </summary>
    <param name="item">A Jellyfin item.</param>
    <returns>Minutes or None.</returns>
    """
