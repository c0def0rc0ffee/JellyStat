...
![The dashboard's overview page](docs/screenshots/01-overview.png)

*The overview page. Every screenshot in this README is taken from an
invented demo library, not from anybody's real viewing history.*
...
![Addon settings: Jellyfin server](docs/screenshots/kodi-01-jellyfin-server.png)
...
![Addon settings: Display](docs/screenshots/kodi-02-display.png)
...
![Addon settings: Web dashboard](docs/screenshots/kodi-03-web-dashboard.png)
...
<img src="docs/screenshots/13-mobile-overview.png" alt="The same page on a phone" width="340">
...
| | |
|---|---|
| [![Discover](docs/screenshots/02-discover.png)](docs/screenshots/02-discover.png)<br>**Discover**: suggestions scored from your own watching, with the weights it used. | [![Film stats](docs/screenshots/03-movies.png)](docs/screenshots/03-movies.png)<br>**Movies**: totals, decades, most replayed, best rated. |
| [![Film library](docs/screenshots/04-movie-library.png)](docs/screenshots/04-movie-library.png)<br>**Film library**: every film, filterable by watched, rated, favourite and genre. | [![TV stats](docs/screenshots/05-tv.png)](docs/screenshots/05-tv.png)<br>**TV**: the same for shows and episodes. |
| [![TV library](docs/screenshots/06-tv-library.png)](docs/screenshots/06-tv-library.png)<br>**TV library**: shows with episodes watched per season. | [![A film's page](docs/screenshots/11-film-detail.png)](docs/screenshots/11-film-detail.png)<br>**A film's page**: badges, cast, logged sittings, similar films. |
| [![A show's page](docs/screenshots/12-show-detail.png)](docs/screenshots/12-show-detail.png)<br>**A show's page**: episodes as cards, ticked where watched. | [![Dashboard settings](docs/screenshots/10-settings.png)](docs/screenshots/10-settings.png)<br>**Settings**: date and clock format, and what recommendations may suggest. |
...
![The Data page](docs/screenshots/09-data.png)
...
![The Rate queue](docs/screenshots/07-rate.png)
...
![Lists](docs/screenshots/08-lists.png)
...
![Addon settings: Website stats](docs/screenshots/kodi-04-website-stats.png)
